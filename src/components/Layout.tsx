      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-24 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 text-primary-700 hover:text-primary-800 transition-colors">
            <img src="/logo.png" alt="AKD Publishing" className="h-20 w-auto" referrerPolicy="no-referrer" />
          </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 text-white mb-4">
              <img src="/logo.png" alt="AKD Publishing" className="h-16 w-auto brightness-0 invert" referrerPolicy="no-referrer" />
            </div>
